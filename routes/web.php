...
Route::post('/lots/{lotId}/create-bet', [BetController::class, "placeBet"])->name('lot-place-bet')->middleware('authCheck');
Route::post('/lots/{lotId}', [LotController::class, "endLot"])->name('lot-end')->middleware('authCheck');
